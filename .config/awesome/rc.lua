...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "s", function () awful.util.spawn_with_shell("gnome-terminal --window-with-profile=Solarized -x screen -RR") end),
    awful.key({ modkey, "Shift" }, "d", function () awful.util.spawn_with_shell("gnome-terminal -x sudo iotop") end),
