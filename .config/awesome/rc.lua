...
beautiful.init("/home/dfanjul/.config/awesome/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.util.spawn_with_shell("PATH=~/bin:$PATH gmrun") end),
    ...
    awful.key({ "Mod1", "Control" }, "s", function () awful.util.spawn_with_shell("gnome-terminal -t alsamixer --window-with-profile=Default -x alsamixer") end),
    ...
    awful.key({ modkey }, "a", function () awful.util.spawn_with_shell("gnome-terminal -t aptitude --window-with-profile=Default -x sudo aptitude") end),
    awful.key({ modkey }, "b", function () awful.util.spawn("google-chrome --profile-directory=Default") end),
    awful.key({ modkey }, "g", function () awful.util.spawn_with_shell("gnome-terminal -t ranger --window-with-profile=Default -x ranger") end),
    awful.key({ modkey }, "s", function () awful.util.spawn_with_shell("gnome-terminal -t screen -x screen -RR") end),
    awful.key({ modkey, "Shift" }, "d", function () awful.util.spawn_with_shell("gnome-terminal -t iotop --window-with-profile=Default -x sudo iotop") end),
    awful.key({ modkey, "Shift" }, "i", function () awful.util.spawn_with_shell("gnome-terminal -t iftop --window-with-profile=Default -x sudo iftop") end),
    awful.key({ modkey, "Shift" }, "t", function () awful.util.spawn_with_shell("gnome-terminal -t top --window-with-profile=Default -x top") end),
