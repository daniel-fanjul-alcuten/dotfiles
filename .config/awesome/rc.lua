...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "a", function () awful.util.spawn_with_shell(terminal .. " -t aptitude -e sudo aptitude") end),
    awful.key({ modkey }, "b", function () awful.util.spawn("x-www-browser") end),
    awful.key({ modkey }, "g", function () awful.util.spawn_with_shell(terminal .. " -t ranger -e ranger") end),
    awful.key({ modkey }, "s", function () awful.util.spawn_with_shell(terminal .. " -t screen -e screen -RR") end),
    awful.key({ modkey, "Shift" }, "d", function () awful.util.spawn_with_shell(terminal .. " -t iotop -e sudo iotop") end),
    awful.key({ modkey, "Shift" }, "i", function () awful.util.spawn_with_shell(terminal .. " -t iftop -e sudo iftop") end),
    awful.key({ modkey, "Shift" }, "t", function () awful.util.spawn_with_shell(terminal .. " -t top -e top") end),
