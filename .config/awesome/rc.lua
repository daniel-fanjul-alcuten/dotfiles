...
globalkeys = awful.util.table.join(
    ...
    -- dfanjul
    awful.key({ "Mod1", "Control" }, "l", function () awful.util.spawn_with_shell("xscreensaver-command -lock") end),
    ...
    awful.key({ "Mod1", "Control" }, "s", function () awful.util.spawn_with_shell("gnome-terminal -t alsamixer -x alsamixer") end),
    ...
    awful.key({ modkey, "Shift" }, "i", function () awful.util.spawn_with_shell("gnome-terminal -t iftop -x sudo iftop") end),
    awful.key({ modkey, "Shift" }, "t", function () awful.util.spawn_with_shell("gnome-terminal -t top -x top") end),
